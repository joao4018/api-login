package com.login.apilogin.constants;

public class SystemConstantsExceptions {
    public static final String ADDRESS_NOT_FOUND_BAD_REQUEST_EXCEPTION = "Address Not Found!";
    public static final String IMPLEMENTED_BY_SPRING_SECURITY_FILTERS =
