package com.login.apilogin.token.token.creator;
...
public class TokenCreator {
    ...
    public SignedJWT createSignedJWT(Authentication auth) {
        ...
        AccessUser applicationUser = (AccessUser) auth.getPrincipal();
    ...
    private JWTClaimsSet createJWTClaimSet(Authentication auth, AccessUser applicationUser) {
